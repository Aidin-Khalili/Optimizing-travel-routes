...
void print(const vector <SOL> &ANSWER)
{
	int i, j;
	for (i = 0; i < ANSWER.size(); i++)
	{
...
int short_distance(const vector<vector<LONG>>& matrix, vector <SOL>& ANSWER, int n, int first, int end, int lenght, int M, SOL& s)
{
